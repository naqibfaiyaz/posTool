$(document).ready(function () {  
	...
	$( ".screen" ).keyup(function( event ) {
		if ( event.which < 48 || event.which > 57) {
			if( event.which!=13 && event.which!=16 && event.which!=17 && event.which!=18 && event.which!=8 && event.which!=187 && event.which!=189 && event.which!=191 && event.which!=190){
				var $myInput = $('.screen');
...
function calculatorFunction(input, btnVal, inputVal, operators, decimalAdded){
